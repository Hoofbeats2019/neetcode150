...
Return ``True`` if it is possible to finish every course. Otherwise, return
``False``.

Example 1:
    Input: numCourses = 2, prerequisites = [[0, 1]]
    Output: True
    Explanation: Take course 1 first, followed by course 0.

Example 2:
    Input: numCourses = 2, prerequisites = [[0, 1], [1, 0]]
    Output: False
    Explanation: Each course requires the other course to be completed first.
...
Pseudocode:
    canFinish(numCourses, prerequisites):
        ...
        return false if any DFS finds a cycle; otherwise return true
